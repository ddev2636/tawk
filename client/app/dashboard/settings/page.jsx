...
//   Info,
// } from "phosphor-react";
import { FaCaretLeft, FaBell, FaLock, FaKey, FaPencilAlt, FaImage, FaRegStickyNote, FaKeyboard, FaInfoCircle } from 'react-icons/fa';
        ...
        >
          ...
          <Stack p={4} spacing={5}>
            ...
            <Stack direction="row" alignItems={"center"} spacing={3}>
              <IconButton>
                <FaCaretLeft size={24} color={"#4B4B4B"} onClick={()=>router.push("/dashboard")}/>
              </IconButton>
            ...
            <Stack direction="row" spacing={3}>
              ...
              <Stack spacing={0.5}>
                ...
                <Typography variant="body2">{faker.word.words()}</Typography>
              </Stack>
            </Stack>
            {/* List */}
            <Stack spacing={4}>
